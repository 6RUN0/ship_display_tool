...
class fittingTools
{
	...
	function moduleInfo($param_moduleArray) {
		...
		*/
		...
		for($h = $hig; $h < $arr['hislots']; $h++) {
			self::$modSlots[27][] = array('id'=> 0,'name'=> 'Empty High Slot', 'iconloc'=> ((self::$simpleurl)?fittingTools::curPageURL():"").'mods/ship_tool_kb/images/equipment/icon00_hig.png', 'metaLevel' => 0, 'techLevel' => 0, 'capacity' => 0, 'volume' => 0, 'mass' => 0);
		}

		for($m = $mid; $m < $arr['medslots']; $m++) {
			self::$modSlots[19][] = array('id'=> 0,'name'=> 'Empty Mid Slot', 'iconloc'=> ((self::$simpleurl)?fittingTools::curPageURL():"").'mods/ship_tool_kb/images/equipment/icon00_mid.png', 'metaLevel' => 0, 'techLevel' => 0, 'capacity' => 0, 'volume' => 0, 'mass' => 0);
		}

		for($l = $low; $l < $arr['lowslots']; $l++) {
			self::$modSlots[11][] = array('id'=> 0,'name'=> 'Empty Low Slot', 'iconloc'=> ((self::$simpleurl)?fittingTools::curPageURL():"").'mods/ship_tool_kb/images/equipment/icon00_low.png', 'metaLevel' => 0, 'techLevel' => 0, 'capacity' => 0, 'volume' => 0, 'mass' => 0);
		}

		for($r = $rig; $r < $arr['rigslots']; $r++) {
			self::$modSlots[92][] = array('id'=> 0,'name'=> 'Empty Rig Slot', 'iconloc'=> ((self::$simpleurl)?fittingTools::curPageURL():"").'mods/ship_tool_kb/images/equipment/icon00_rig.png', 'metaLevel' => 0, 'techLevel' => 0, 'capacity' => 0, 'volume' => 0, 'mass' => 0);
		}

		if(!empty(self::$modSlots[125])) {
			foreach(self::$modSlots[125] as $i => $value) {
	...
	function applyShipSkills($bonus, $type, $mode, $effect, $shipEff, $skillBonus, $negEffect, $groupID, $capacity, $modName, $techLevel, $moduleLevel, $mass) {
		...
		//ordering
		if($moduleLevel == 92) {//rig
			$slotOrder = 2;
		} else if($moduleLevel == 19) {//mid
			$slotOrder = 4;
		} else if($moduleLevel == 11) {//low
			$slotOrder = 3;
		} else if($moduleLevel == 125) {//sub
			$slotOrder = 1;
		}
		...
		if(strtolower($effect) == "passivearmoremdamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passivearmorthermaldamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passivearmorkineticdamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passivearmorexplosivedamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passiveshieldemdamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passiveshieldthermaldamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passiveshieldkineticdamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "passiveshieldexplosivedamageresonance" && $moduleLevel == 125) {
			if($bonus < 1 && $bonus != 0) {
				$bonus = (1-$bonus)*100;
			}
			if($bonus != 0) {
		...
		if(strtolower($effect) == "capacitorcapacity" && $moduleLevel == 125) {
			if($bonus != 0) {
		...
		if(strtolower($effect) == "rechargerate" && $moduleLevel == 125) {
			if($bonus != 0) {
	...
	function displayShipStats($param_ship, $param_shipimgx, $param_shipimgy) {
		...
		$smarty->assign('modSlotsh', self::$modSlots[27]);
		$smarty->assign('modSlotsm', self::$modSlots[19]);
		$smarty->assign('modSlotsl', self::$modSlots[11]);
		$smarty->assign('modSlotsr', self::$modSlots[92]);
		$smarty->assign('modSlotss', self::$modSlots[125]);
